...
export const ChatMessages = ({
  ...
  const chatRef = useRef<ElementRef<'div'> | null>(null);
  const bottomRef = useRef<ElementRef<'div'> | null>(null);

  const { hasNextPage, isFetchingNextPage, fetchNextPage, status, data } =
    useChatQuery({
      queryKey,
      apiUrl,
      paramKey,
